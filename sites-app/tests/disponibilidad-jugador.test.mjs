...
test("15b. CSS: filas compactas muted, heading tipo eyebrow diferenciado, sin barras, con :empty", () => {
  ...
  // PR #52 — el heading dejó de ser una fila más: eyebrow compacto (Oswald 10px,
  ...
  // PR #52 — separador hairline permitido (border-top 1px), pero sin fondo ni caja de card.
